...
window.addEventListener("load", function () {
    ...
    document.getElementById("contactForm").addEventListener("submit", async function(event) {
        ...
        const contact = {
            ...
            honeypot: document.getElementById("contactHoneypot").value, // if any value received in this field, form submission will be ignored.
            message: document.getElementById("contactMessage").value,
            replyTo: '@' + document.getElementById("contactEmail").value, // this will set replyTo of email to email address entered in the form
            accessKey: '3c719df6-6343-4feb-8a5c-3863a617756d' // get your access key from https://www.staticforms.xyz
        }
        try {
            ...
            if (json.success) {
                alert('Your message has been successfully submitted. I will answer you very shortly.');
            } else {
                alert('An error occurred. Please try to contact me through one of the social medias link on the left side of Contact.');
            }
        } catch (error) {
            alert('An error occurred. Please try to contact me through one of the social medias link on the left side of Contact.');
        }
